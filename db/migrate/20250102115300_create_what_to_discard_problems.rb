class CreateWhatToDiscardProblems < ActiveRecord::Migration[7.2]
  def change
    create_table :what_to_discard_problems do |t|
      ...
      t.references :point_east, foreign_key: { to_table: :tiles},  null: false
      t.references :point_south, foreign_key: { to_table: :tiles},  null: false
      t.references :point_west, foreign_key: { to_table: :tiles},  null: false
      t.references :point_north, foreign_key: { to_table: :tiles},  null: false
